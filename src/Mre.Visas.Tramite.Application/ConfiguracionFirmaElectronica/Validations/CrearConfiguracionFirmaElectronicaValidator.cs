...
{
    public class CrearConfiguracionFirmaElectronicaValidator : AbstractValidator<CrearConfiguracionFirmaElectronicaCommand>
    {
        public CrearConfiguracionFirmaElectronicaValidator()
        {
